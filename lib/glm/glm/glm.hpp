...
/// @file glm/glm.hpp
///
/// @defgroup vk_core Core features
///
/// @brief Features that implement in C++ the GLSL specification as closely as possible.
///
/// The GLM vk_core consists of C++ types that mirror GLSL types and
...
/// (pdf file)</a>.
///
/// GLM vk_core functionalities require <glm/glm.hpp> to be included to be used.
///
///
